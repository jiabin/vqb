	...
	this.GUITemplates = {
		...
		editor : $([
			'<div class="jcsdl-mainview">',
				...
				'<div class="jcsdl-footer">',
					'<div class="jcsdl-mainview-actions">',
                        '<a href="#" class="jcsdl-btn jcsdl-editor-cancel">Cancel</a>',
                        '<a href="#" class="jcsdl-btn jcsdl-editor-save">Save and Preview</a>',
					'</div>',
				'</div>',
			'</div>'
		].join('')),
		...
		filterEditor : $([
			'<div class="jcsdl-filter-editor">',
				...
				'</div>',
				'<div class="jcsdl-footer">',
					'<a href="#" class="jcsdl-btn jcsdl-elements-sprite jcsdl-filter-save">Save and Preview</a>',
